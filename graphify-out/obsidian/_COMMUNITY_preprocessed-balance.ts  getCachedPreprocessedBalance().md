...
# preprocessed-balance.ts / getCachedPreprocessedBalance()
...
```dataview
TABLE source_file, type FROM #community/preprocessed-balance.ts_/_getCachedPreprocessedBalance()
SORT file.name ASC
```

## Connections to other communities
- 12 edges to [[_COMMUNITY_getDb()  getOrCreateWorkspace()]]
