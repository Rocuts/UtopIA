...
- [[renderCurrentDiagnosis()]] - `contains` [EXTRACTED]
- [[renderRecommendations()_1]] - `contains` [EXTRACTED]
- [[renderRoadmap()]] - `contains` [EXTRACTED]
- [[renderSavingsProjection()]] - `contains` [EXTRACTED]
