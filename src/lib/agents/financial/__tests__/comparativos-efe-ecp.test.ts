...
describe('E6 del periodo comparativo — ORI del ERI comparativo == Δ ORI del ECP comparativo (integración I2)', () => {
  ...
  it('revisión I2 / enmienda 12: un grupo 38 que se movió sólo en el comparativo no bloquea el informe honesto (ORI comparativo = Δ38)', () => {
    ...
    // en la columna ORI. La revisión I2 fijó aquí ORI comparativo $0 en el ERI
    // porque E6b lo exigía; esa cifra contradecía al ECP comparativo (NIIF para
    // las PYMES 6.3(c)). Con la enmienda 12 (spec v2.1) el ORI del ERI es la
    // Δ38 de cada periodo: el informe honesto presenta $5.000.000 y $0 es error.
    ...
    expect(validar(cero, pp38).errors.some((e) => e.startsWith('E6b.'))).toBe(true);
  });
});
