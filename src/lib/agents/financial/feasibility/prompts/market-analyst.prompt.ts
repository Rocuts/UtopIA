...
export function buildMipymeClassificationBlock(): string {
  ...
  return [
    '- Clasificacion MIPYME (Decreto 957/2019, compilado en el Decreto 1074/2015 arts. 2.2.1.13.2.1-2): criterio exclusivo = ingresos por actividades ordinarias anuales del ano anterior, en UVT, segun macrosector (pesos con UVT 2026 = $52.374, referencial):',
    ...rows,
