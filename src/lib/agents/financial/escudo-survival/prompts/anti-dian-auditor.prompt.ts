...
- Regimen ESPECIAL (§5: agro / comercializador SIMPLE / cooperativa de productores agricolas), para explicar en el markdown: exceso = max(0, pagos en efectivo del año - 0.70 x costosTotales). NO apliques el §1 ni el §2 a estos contribuyentes, y declara en warnings y en el markdown que se aplico el Art. 771-5 §5 E.T. y por que. La cuantia tambien es N/D sin flujo de pagos (data.excesoNoDeducibleGeneral = null).
