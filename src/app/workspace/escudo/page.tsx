 ...
 *
 * La auto-lectura del FiscalSnapshot (localStorage `lastCompletedReport` +
 * fallback `GET /api/escudo/fiscal-anchor`) y el estado vacío viven ahora en
 * `EscudoArea` vía `useAncoraView`. Esta página solo monta el área + el strip
 * de chat contextual.
 *
