...
/**
 * /workspace/escudo/precios-transferencia — submódulo en preparación.
 *
 ...
 * El CTA abre el flujo real existente (`transfer_pricing`) con los datos del
 * usuario.
 */
...
export default function PreciosTransferenciaPage() {
  const { t } = useLanguage();
  const sub = t.elite.areas.escudo.submodules.preciosTransferencia;
  return (
    <ModuleInPreparation
      area="escudo"
      title={sub.title}
      ...
      icon={ArrowLeftRight}
      intakeCaseType="transfer_pricing"
    />
  );
}
