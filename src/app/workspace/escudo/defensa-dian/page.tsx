...
/**
 * /workspace/escudo/defensa-dian — submódulo en preparación.
 *
 ...
 * El CTA abre el flujo real existente (`dian_defense`) con los datos del
 * usuario.
 */
...
export default function DefensaDianPage() {
  const { t } = useLanguage();
  const sub = t.elite.areas.escudo.submodules.defensaDian;
  return (
    <ModuleInPreparation
      area="escudo"
      title={sub.title}
