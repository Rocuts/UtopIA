    ...
    <li className="flex items-center gap-2 text-xs">
      <span
        ...
        className={cn(
          ...
          status === 'pending' && 'bg-n-300/40',
        )}
      />
      <span
        className={cn(
          'transition-colors',
          status === 'completed' && 'text-n-700',
          status === 'started' && 'text-n-800 font-medium',
    ...
    <button
      ...
      className={cn(
        ...
        selectedMode === mode
          ...
          : 'bg-n-100/60 text-n-800 hover:bg-n-200/60',
      )}
    >
      {label}
    </button>
      ...
      {isIdle && (
        <motion.section {...fadeItem(0)} aria-label={fiscal.uploadLabel}>
          <div className="rounded-xl p-6 md:p-8 glass-elite-elevated ring-1 ring-[rgb(168_56_56_/_0.3)]">
            <p className="text-base text-n-700 mb-6 leading-relaxed max-w-2xl">
              {fiscal.intro}
            </p>
        ...
        >
          <div className="rounded-xl p-6 glass-elite-elevated ring-1 ring-[rgb(168_56_56_/_0.3)]">
            ...
            <div
              ...
              aria-valuemax={100}
              aria-label={fiscal.analyzing}
              className="h-1.5 w-full rounded-full bg-n-200/40 overflow-hidden mb-4"
            >
              <motion.div
            ...
            <div className="mt-4 flex gap-3">
              <button
                ...
                className={cn(
                  ...
                  'bg-n-100 text-n-800',
                  'hover:bg-n-200 transition-colors',
