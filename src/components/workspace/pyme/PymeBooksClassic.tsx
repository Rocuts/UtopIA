...
/**
 * PymeBooksClassic — listado "profesional" de libros del módulo Pyme.
 *
 * Era el antiguo `PymeLanding`. Desde el rediseño mobile-first (cockpit
 * "Don Carlos"), `/workspace/pyme` muestra el cockpit y ESTE componente
 * (lista + creación de libros reales, con su fetch a `/api/pyme/books`) se
 * preserva intacto en la ruta `/workspace/pyme/libros`, enlazada desde la
 * pantalla "Mi Libro" (V3) del cockpit. Cero pérdida de funcionalidad.
 *
...
export function PymeBooksClassic() {
