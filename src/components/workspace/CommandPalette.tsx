...
const LABELS = {
  es: {
    ...
    newConsultationSub: 'Iniciar una conversacion nueva',
    exportPdf: 'Exportar PDF',
    exportPdfSub: 'Descargar el analisis actual',
    clearChat: 'Limpiar chat',
    clearChatSub: 'Borrar la conversacion actual',
    toggleVoice: 'Activar voz',
    toggleVoiceSub: 'Entrada por microfono',
    dianDefense: 'Defensa DIAN',
    dianDefenseSub: 'Requerimientos y recursos tributarios',
    taxRefund: 'Devolucion de impuestos',
    taxRefundSub: 'Solicitudes de saldo a favor',
    dueDiligence: 'Due Diligence',
    dueDiligenceSub: 'Revision de cumplimiento fiscal',
    financialIntel: 'Inteligencia financiera',
    financialIntelSub: 'Analisis de riesgos SAGRILAFT',
  },
  en: {
